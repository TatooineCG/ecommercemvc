...
class Rotas {
    ...
    private $parametro = [];
        ...
        public function __construct()
        {
            ...
            if(file_exists('../sistema/Controllers/'.ucwords($url[0]).'.php')){
            ...
            require_once '../sistema/Controllers/'.$this->controlador.'.php';
            ...
            call_user_func_array([$this->controlador, $this->principal], $this->parametro);
